  ...
  head: () => ({
    meta: [
      ...
      { title: "Musicosy — Everything music. One place." },
      {
        name: "description",
        content:
          "Musicosy is the social platform where creators, indie artists, labels, sync agents, distributors and advertisers meet in one place.",
      },
      { name: "author", content: "Musicosy" },
      { property: "og:title", content: "Musicosy — Everything music. One place." },
      {
        property: "og:description",
        content:
          "Post, discover, license and monetize music in one social platform built for the new music economy.",
      },
